...
const Dashboard = () => {
  ...
  const metrics = useMemo(() => {
    ...
    if (!transactions.length) return defaultMetrics;
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.8fr_1.2fr] gap-8">
        <div className="glass-panel p-8 flex flex-col">
          <div className="text-2xl font-semibold text-white mb-8 border-b border-white/10 pb-4">Real-Time Transaction Feed</div>
          <div className="flex flex-col gap-5 max-h-[450px] overflow-y-auto pr-3 custom-scrollbar">
            ...
            {transactions.length === 0 && (
              <div className="text-textSecondary text-center p-8">No transactions found.</div>
            )}
          </div>
        </div>
